 ...
 * Each card: icon area, service name, short description, subtle hover lift.
 * FadeIn stagger 0.1s.
 */
            ...
            <FadeIn key={service.id} delay={index * 0.1}>
              <Link href={`/services/${service.slug}`} className="block group">
                <div className="p-5 md:p-8 rounded-lg border border-border bg-white hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ...
                  {/* Content */}
                  <h3 className="font-heading text-xl font-semibold text-text-primary mb-3 group-hover:text-primary transition-colors duration-200">
                    {service.name}
                  </h3>
